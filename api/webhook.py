...
@bot.message_handler(commands=['start'])  # Fixed indentation
async def start(message):
    user_id = str(message.from_user.id)  # Fixed `Str` to `str`
    user_first_name = str(message.from_user.first_name)  # Fixed `Str` to `str`
    user_last_name = message.from_user.last_name
    user_username = message.from_user.username
    user_language_code = str(message.from_user.language_code)
    is_premium = message.from_user.is_premium

    welcome_message = (  # Fixed spelling of `wellcome_message`
